...
def train(config, args):
    ...
    os.system("onmt_train -data {model} -save_model {model} {params}".format(workdir=thisdir, model=os.path.join(model_dir,"model"), params=config["train_parameters"]))
